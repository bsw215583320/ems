...
$(".sidebar-menu").find(".active").removeClass("nei_active");
    if(pingWidth>767){
        ...
        $(".indexPie").css({"height":(pingHeight-80)*2/5,"width":(pingWidth-260)*2/5})
    }else{
        $(".ssjc_ru_table").css({"height":pingHeight-174})
        $(".ssjc_ru_table1").css({"height":pingHeight-130})
        $(".indexPie").css({"height":(pingHeight-130)*2/5,"width":(pingWidth-260)*2/5})
    }
}else{
...
$(".sidebar-menu").find(".active").addClass("nei_active")
    if(pingWidth>767){
        $(".ssjc_ru_table").css({"height":pingHeight-120})
        $(".ssjc_ru_table1").css({"height":pingHeight-80})
        $(".indexPie").css({"height":(pingHeight-80)*2/5,"width":(pingWidth-80)*2/5})
    }else{
        $(".ssjc_ru_table").css({"height":pingHeight-174})
        $(".ssjc_ru_table1").css({"height":pingHeight-130})
        $(".indexPie").css({"height":(pingHeight-130)*2/5,"width":(pingWidth-30)*2/5})
    }
}})
// 设置侧导航栏的侧导航样式兼容
