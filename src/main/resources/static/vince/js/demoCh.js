...
$(".sidebar-menu").find(".active").removeClass("nei_active");
    if(pingWidth>767){
        $(".ssjc_ru_table").css({"height":pingHeight-120})
        $(".ssjc_ru_table1").css({"height":pingHeight-80})
        $(".echarts1").css({"height":(pingHeight-80)/2,"width":(pingWidth-260)/2})
        $(".echarts2").css({"height":(pingHeight-80)/2,"width":(pingWidth-260)/2,"margin-left":(pingWidth-260)/2})
        $(".echarts3").css({"height":(pingHeight-80)/2,"width":(pingWidth-260)/2,"margin-top":(pingHeight-80)/2})
        $(".echarts4").css({"height":(pingHeight-80)/2,"width":(pingWidth-260)/2,"margin-left":(pingWidth-260)/2,"margin-top":(pingHeight-80)/2})
    }else{
        $(".ssjc_ru_table").css({"height":pingHeight-174})
        $(".ssjc_ru_table1").css({"height":pingHeight-130})
        $(".echarts1").css({"height":(pingHeight-130)/2,"width":(pingWidth-260)/2})
        $(".echarts2").css({"height":(pingHeight-130)/2,"width":(pingWidth-260)/2,"margin-left":(pingWidth-260)/2})
        $(".echarts3").css({"height":(pingHeight-130)/2,"width":(pingWidth-260)/2,"margin-top":(pingHeight-130)/2})
        $(".echarts4").css({"height":(pingHeight-130)/2,"width":(pingWidth-260)/2,"margin-left":(pingWidth-260)/2,"margin-top":(pingHeight-130)/2})
    }
}else{
...
$(".sidebar-menu").find(".active").addClass("nei_active")
    if(pingWidth>767){
        $(".ssjc_ru_table").css({"height":pingHeight-120})
        $(".ssjc_ru_table1").css({"height":pingHeight-80})
        $(".echarts1").css({"height":(pingHeight-80)/2,"width":(pingWidth-80)/2})
        $(".echarts2").css({"height":(pingHeight-80)/2,"width":(pingWidth-80)/2,"margin-left":(pingWidth-80)/2})
        $(".echarts3").css({"height":(pingHeight-80)/2,"width":(pingWidth-80)/2,"margin-top":(pingHeight-80)/2})
        $(".echarts4").css({"height":(pingHeight-80)/2,"width":(pingWidth-80)/2,"margin-left":(pingWidth-80)/2,"margin-top":(pingHeight-80)/2})
    }else{
        $(".ssjc_ru_table").css({"height":pingHeight-174})
        $(".ssjc_ru_table1").css({"height":pingHeight-130})
        $(".echarts1").css({"height":(pingHeight-130)/2,"width":(pingWidth-30)/2})
        $(".echarts2").css({"height":(pingHeight-130)/2,"width":(pingWidth-30)/2,"margin-left":(pingWidth-30)/2})
        $(".echarts3").css({"height":(pingHeight-130)/2,"width":(pingWidth-30)/2,"margin-top":(pingHeight-130)/2})
        $(".echarts4").css({"height":(pingHeight-130)/2,"width":(pingWidth-30)/2,"margin-left":(pingWidth-30)/2,"margin-top":(pingHeight-130)/2})
    }
}})
// 设置侧导航栏的侧导航样式兼容
...
console.info(pingHeight);
$(".qqq").css({"height":pingHeight});
$(".requtu").css({"maxHeight":pingHeight})
$(".content-wrapper").css({"height":pingHeight})
...
// 首页热区信息自适应
  $(".labelone").css({"top":pageWidth*0.09,"left":pageWidth*0.70})
    $(".labeltwo").css({"top":pageWidth*0.05,"left":pageWidth*0.44})
